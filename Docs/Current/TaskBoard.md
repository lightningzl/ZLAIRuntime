...
| `M6-06` | `进行中` | 关系感知 Rule Decision | Investigate、Relationship/Memory/Faction/Occupation 评分、Reason Code 和重复报告约束 | `M6-03`、`M6-04`、`M6-05` | 自动化覆盖 `M6-A07`，验证规则路径不产生 Decision HTTP 请求，且相同输入可复现 |
