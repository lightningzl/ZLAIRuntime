...
| `M6-05` | `进行中` | Important NPC Long Memory | Level 2 Profile、Short/Long 容量、Promotion、Decay、Eviction 和结构化 Top-K 检索 | `M6-02` | 自动化覆盖 `M6-A06`，不访问 Dialogue Memory 或 SQLite |
