...
- 里程碑状态：`实施中`
- 当前活动工作包：`M7-T06` 对话/动作气泡与感知开发视图
- 下一工作包：`M7-T07` 场景纵向闭环与自动化
...
| `M7-T06` | 对话/动作气泡与感知开发视图 | 玩家气泡、规则占位回应、动作状态、逐 NPC Observation 与过滤原因 | `M7-T02`, `M7-T04`, `M7-T05` | `进行中` | 满足 `M7-A08`，主要结果无需查看日志 |
