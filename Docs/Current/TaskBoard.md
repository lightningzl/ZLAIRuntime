...
- 里程碑状态：`实施中`
- 当前活动工作包：`M7-T02` 文本交互 UI 与输入边界
- 下一工作包：`M7-T03` Speech/Action Event 与个人 Observation
...
| `M7-T02` | 文本交互 UI 与输入边界 | 说话/行为切换、文本框、Whisper/Talk/Shout/InEar、可选目标、可见校验错误 | `M7-T01` | `进行中` | 满足 `M7-A03`，无无效 Gameplay 副作用 |
