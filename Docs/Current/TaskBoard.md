...
- 里程碑状态：`规划中`
- 当前活动工作包：`M13-T03` DataTable/DataRegistry 批量工作流
- 下一工作包：`M13-T04` NPC Spawner 与 Persona 解析
...
| `M13-T03` | DataTable/DataRegistry 批量工作流 | JSON 批量覆盖/新增、导出、逐行报告、ID 下拉 | `M13-T01` | `进行中` | 满足 `M13-A02`、`M13-A03` |
