...
- 里程碑状态：`进行中`
- 当前活动工作包：`M8-T04` UE Decision Client 与个人上下文
- 下一工作包：`M8-T05` Tool Registry 与权威校验
...
| `M8-T04` | UE Decision Client 与个人上下文 | 单 NPC 选择、个人 Observation 裁剪、异步请求、响应解析和一次完成语义 | `M8-T02` | `进行中` | 支撑 `M8-A03`、`M8-A07`、`M8-A08`、`M8-A09` 的客户端部分 |
