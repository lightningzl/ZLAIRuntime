...
- 里程碑状态：`规划中`
- 当前活动工作包：`M13-T02` Asset 单条 JSON 工作流
- 下一工作包：`M13-T03` DataTable/DataRegistry 批量工作流
...
| `M13-T02` | Asset 单条 JSON 工作流 | Asset 编辑器导入/导出、Schema 校验和失败不写入语义 | `M13-T01` | `进行中` | 满足 `M13-A01` |
