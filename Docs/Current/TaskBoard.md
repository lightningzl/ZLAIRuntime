...
| `M6-04` | `进行中` | 稀疏 Relationship 与 Faction Authority | Personal Relationship、Reputation、Faction Standing、确定性 Delta 与 Authority Capability | `M6-02` | 自动化覆盖 `M6-A04`、`M6-A05`，不预建 N×N 图 |
