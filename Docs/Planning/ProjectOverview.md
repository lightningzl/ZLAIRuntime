...
5. **下一阶段：可操作交互舞台与定向感知**——玩家能移动、输入说话或行为，并直接观察 NPC 的个人感知与气泡反馈。
6. **单 NPC LLM 具身反馈**——经协议确认后，让一个关键 NPC 根据个人视角生成语言和受控动作。
7. **连续互动与冲突变化**——让 NPC 随距离、行为、道歉、威胁和冲突结果持续重新判断。
8. **最终场景 1 交付**——3 至 5 个差异化 NPC 完成开放式社会交互沙盒验收。
