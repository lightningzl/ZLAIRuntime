...
9. **当前：社会后果与角色行为打磨**——让攻击、缓和、报告与最小交易尝试形成按个人感知隔离的连续后果；当前范围见 [Milestone 12](../Current/CurrentMilestone.md)。
10. **后续候选扩展**——NPC 间协作、跨时间后果、社会 Memory 持久化、语义检索或多人 Server Authority，进入新里程碑前另行定义范围。
